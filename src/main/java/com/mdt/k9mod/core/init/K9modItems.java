...
public class K9modItems {
    ...
    public static final RegistryObject<Item> K9_WRENCH = ITEMS.register(
            "k9_wrench", () -> new Item(new Item.Properties().defaultDurability(16).tab(ItemGroup.TAB_REDSTONE).stacksTo(1)));
    public static final RegistryObject<Item> K9_BONE = ITEMS.register(
            "k9_bone", () -> new BoneItem(new Item.Properties().defaultDurability(8).tab(ItemGroup.TAB_REDSTONE).stacksTo(1)));
}
