...
public class K9Containers {
    ...
    public static final RegistryObject<ContainerType<K9InventoryContainer>> K9_CONTAINER = CONTAINERS.register("k9_container",
            () -> IForgeContainerType.create((((windowId, inv, data) -> new K9InventoryContainer(windowId,inv)))));
