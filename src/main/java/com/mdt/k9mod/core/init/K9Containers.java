...
public class K9Containers {
    ...
    public static final RegistryObject<MenuType<K9InventoryContainer>> K9_CONTAINER = CONTAINERS.register("k9_container", () -> new MenuType<>(K9InventoryContainer::getClientMenu, FeatureFlagSet.of()));
