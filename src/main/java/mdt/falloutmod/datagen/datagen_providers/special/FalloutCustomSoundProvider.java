...
public abstract class FalloutCustomSoundProvider implements DataProvider {
    protected final FabricDataOutput dataOutput;

    protected FalloutCustomSoundProvider(FabricDataOutput dataOutput) {
        this.dataOutput = dataOutput;
    }
    public abstract void generateSoundsData(FalloutCustomSoundBuilder falloutCustomSoundBuilder);
    @Override
