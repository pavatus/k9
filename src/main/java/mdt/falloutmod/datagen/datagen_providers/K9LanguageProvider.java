...
import mdt.falloutmod.datagen.LanguageType;
...
public class K9LanguageProvider extends FabricLanguageProvider {
    ...
    public K9LanguageProvider(FabricDataOutput dataOutput, LanguageType languageType) {
    ...
    public void generateTranslations(TranslationBuilder translationBuilder) {
        ...
        try {
            translationBuilder.add(dataGenerator.getModContainer().findPath("assets/falloutmod/lang/" + languageType.name().toLowerCase() + ".existing.json").get());
        } catch (Exception e) {
