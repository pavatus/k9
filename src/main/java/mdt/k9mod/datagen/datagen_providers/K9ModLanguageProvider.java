...
import mdt.k9mod.datagen.LanguageType;
...
public class K9ModLanguageProvider extends FabricLanguageProvider {
    ...
    public K9ModLanguageProvider(FabricDataOutput dataOutput, LanguageType languageType) {
