...
public abstract class K9ModCustomSoundProvider implements DataProvider {
    protected final FabricDataOutput dataOutput;

    protected K9ModCustomSoundProvider(FabricDataOutput dataOutput) {
        this.dataOutput = dataOutput;
    }
    public abstract void generateSoundsData(K9ModCustomSoundBuilder k9ModCustomSoundBuilder);
    @Override
